...
// Replace scripts, Scripts — See README.adoc for details., just run, Scripts started successfully. with actuals
= scripts — Quick Start for Users
:toc:
:toclevels: 2

== What is scripts?

Scripts — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./scripts-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/scripts/wiki
