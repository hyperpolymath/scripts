...
git clone https://github.com/hyperpolymath/scripts.git cd scripts
...
toolbox create scripts-dev toolbox enter scripts-dev # Install
...
scripts/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
